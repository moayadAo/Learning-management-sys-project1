          ...
          child: ListView(
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  Navigator.pushNamed(
                      context, AppRoute.scholarshipStudentsPage);
                },
              ),
              institute
                  ? Column(
                      children: [
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            Navigator.pushNamed(
                                context, AppRoute.institutionStudentsPage);
                          },
                        ),
                        const Divider(height: 6, thickness: 1),
                        ListTile(
                          ...
                          onTap: () {
                            Navigator.pushNamed(
                                context, AppRoute.payStudentPage);
                          },
                        ),
                        const Divider(height: 6, thickness: 1),
                        ListTile(
                          ...
                          onTap: () {
                            Navigator.pushNamed(
                                context, AppRoute.addScholarshipsPage);
                          },
                        ),
                        const Divider(height: 6, thickness: 1),
                        ListTile(
                          ...
                          onTap: () {
                            Navigator.pushNamed(
                                context, AppRoute.scholarshipsRequestsPage);
                          },
                        ),
                        const Divider(height: 6, thickness: 1),
                        ListTile(
                            ...
                            onTap: () {
                              Navigator.pushNamed(
                                  context, AppRoute.teacherRequest);
                            }),
                        const Divider(height: 6, thickness: 1),
                        ListTile(
                            title: RichText(
