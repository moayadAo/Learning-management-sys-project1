...
class SliverAppBarScholarship extends StatelessWidget {
   SliverAppBarScholarship({super.key,required this.onChanged,required this.iconClosePressed});
      ...
      flexibleSpace: FlexibleSpaceBar(
        background: Stack(children: [
          Positioned(
            ...
            child: BlocBuilder<SearchScholarshipsCubit, SearchScholarshipsState>(
