...
class SignUpScreenTeacher extends StatelessWidget {
  ...
  Future<void> _pickerFromGallery(
    ...
    if (imageGallery != null) {
      ...
      context.read<TeacherCubit2>().uploadProfilePic(_imagePick);
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<TeacherCubit2, TeacherStates>(
                ...
                child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        state is CvLoadingTeacherState
                            ? LoadingIndicator()
                            : ElevatedButton(
                                onPressed: () async {
                                  _cvFile = await context
                                      .read<TeacherCubit2>()
                                      .pickDocument();
                                },
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: state is CvLoadedTeacherState
                        ...
                        TextFieldWithLabel(
                          ...
                          child: TextFiledApp(
                            ...
                            validator: (value) => ValidatorManager()
                                .validateName(value!, message: 'enter subject'),
                          ),
                        ),
                        const SizedBox(height: 20),
                        TextFieldWithLabel(
                          ...
                          child: TextFiledApp(
                            ...
                            validator: (value) => ValidatorManager()
                                .validateName(value!, message: 'enter Summary'),
                          ),
                        ),
                        const SizedBox(height: 20),
                              ...
                              : ElevatedButton(
                                  ...
                                  onPressed: () {
                                    if (_formKey.currentState!.validate()) {
                                      context.read<TeacherCubit2>().addTeacher(
